...
export const QuizModal = ({
  ...
  const handleAnswerSubmit = () => {
    ...
    if (currentQuestion.type === "mcq") {
      ...
      const correctAnswerNormalized = String(currentQuestion.correctAnswer)
        .toLowerCase()
        .trim();
            ...
            {showRetryMessage ? (
                ...
                <div className="mb-8">
                  ...
                  {currentQuestion.type === "true-false" && (
                    <RadioGroup
                      value={String(answers[currentQuestionIndex] ?? "")}
                      onValueChange={(value) =>
                        handleTrueFalseAnswer(value === "true")
                      }
                      className="space-y-3"
                    >
              ...
              >
                ...
                <p className="text-lg mb-6">
                  You've mastered this section with a perfect score! The next
                  scroll has been unsealed.
                </p>
