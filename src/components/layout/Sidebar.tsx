...
export const Sidebar = ({ currentSection, onSectionClick, isOpen, onClose }: SidebarProps) => {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:block fixed left-0 top-16 bottom-0 w-80 bg-card/80 backdrop-blur-md border-r border-primary/20 overflow-y-auto shadow-mystical z-40">
        {sidebarContent}
      </aside>
      ...
      <Sheet open={isOpen} onOpenChange={onClose}>
        <SheetContent 
          side="left" 
          className="w-80 bg-card/95 backdrop-blur-md p-0 border-primary/20"
        >
          <SheetHeader className="p-6 pb-0">
            <SheetTitle className="font-cinzel glow-purple">Navigation</SheetTitle>
          </SheetHeader>
